...
export default function Documents() {
    ...
    return (
        <ScrollView className="bg-[#EEF9FB]">
            ...
            <TouchableOpacity className="positioin-absolute pl-4 pr-4 mdc-fab flex-row bg-[#5085A8] h-14 self-center items-center rounded-2xl">
                <View className="mdc-fab_ripple"></View>
                <MaterialIcons className="border-2 rounded-full p-1 items-center border-[#fff]" name="add" color="#fff" />
                <Text className=" text-[#fff] font-medium">  Add a document</Text>
            </TouchableOpacity>
