                    ...
                    <View className="w-full bg-[#EEF9FB] rounded-3xl p-6 relative">
                        ...
                        <View className="mt-6 mb-4">
                            <Text className="text-2xl font-semibold mb-4 text-[#000]">
                                {t(`mr-gynecological.${inputConfig.title}`)}
                            </Text>
                            <TextInput
                                placeholder={t(`mr-gynecological.noSpec`)}
                                value={value}
                        ...
                        <View className="mt-4">
                            ...
                            >
                                <Text className="self-center text-white font-medium text-base">{t(`mr-gynecological.confirm`)}</Text>
                            </TouchableOpacity>
                        </View>
                    </View>
                </View>
        ...
        <ScrollView className="bg-[#EEF9FB] flex-1">
            ...
            <View className="m-4">
                <View className="pl-4 pt-6">
                    <Text className="text-2xl font-medium">{t(`mr-gynecological.title`)}</Text>
                </View>
                    ...
                    return (
                        ...
                        <View key={field.key} className="mt-6" >
                            ...
                            >
                                ...
                                <View>
                                    <Text className="text-base text-xl font-medium">{t(`mr-gynecological.${field.title}`)}</Text>
                                    <Text className="pt-2 text-base">{value.trim() ? value : t(`mr-gynecological.noSpec`)}</Text>
                                </View>
